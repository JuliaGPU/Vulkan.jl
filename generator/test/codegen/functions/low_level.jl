@testset "API functions" begin
    test_ex(APIFunction(api.functions[:vkEnumeratePhysicalDevices], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkGetPhysicalDeviceProperties], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkEnumerateInstanceVersion], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkEnumerateInstanceExtensionProperties], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkGetGeneratedCommandsMemoryRequirementsNV], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkGetInstanceProcAddr], false), :(_get_instance_proc_addr(name::AbstractString; instance = C_NULL)::FunctionPtr = vkGetInstanceProcAddr(instance, name)))
    test_ex(APIFunction(api.functions[:vkGetInstanceProcAddr], true), :(_get_instance_proc_addr(name::AbstractString, fptr::FunctionPtr; instance = C_NULL)::FunctionPtr = vkGetInstanceProcAddr(instance, name, fptr)))

    test_ex(APIFunction(api.functions[:vkGetPhysicalDeviceSurfacePresentModesKHR], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkGetRandROutputDisplayEXT], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkRegisterDeviceEventEXT], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkCreateInstance], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkCreateDebugReportCallbackEXT], true), :(
    ...
    test_ex(APIFunction(api.functions[:vkCreateGraphicsPipelines], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkAllocateDescriptorSets], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkGetFenceFdKHR], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkGetDeviceGroupPeerMemoryFeatures], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkUpdateDescriptorSets], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkCmdSetViewport], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkCmdSetLineWidth], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkDestroyInstance], false), :(
        _destroy_instance(instance; allocator = C_NULL)::Cvoid = @dispatch instance vkDestroyInstance(instance, allocator)
    ))

    test_ex(APIFunction(api.functions[:vkMapMemory], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkEnumeratePhysicalDeviceQueueFamilyPerformanceQueryCountersKHR], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkWriteAccelerationStructuresPropertiesKHR], false), :(
    ...
    test_ex(APIFunction(api.functions[:vkGetQueryPoolResults], false), :(
    ...
    @testset "Automatic reconstruction of create infos" begin
        test_ex(APIFunction(api.constructors[:vkCreateInstance], false), :(
        ...
        test_ex(APIFunction(api.constructors[:vkCreateDebugReportCallbackEXT], true), :(
